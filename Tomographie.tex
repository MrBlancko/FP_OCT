...
Bei der Frequency Domain OCT wird nicht nur ein einfaches Interferenzsignal, sondern das gesamte Interferenzspektrum aufgenommen, indem das Licht spektral zerlegt wird. Damit kann die gesamte Tiefeninformation gleichzeitig aufgenommen werden und das Signal-Rausch-Verhältnis ist wesentlich besser. Es gibt zwei Varianten: Die Spectral Domain OCT, bei der das Licht durch ein Spektrometer gefiltert wird, und die Swept Source OCT, bei der die Wellenlänge des Lichts durchgestimmt wird. Die Wiederholungsrate wird bei SD OCT durch die Auslesegeschwindigkeit der Fotochips bestimmt, bei der SS OCT durch die Durchstimmgeschwindigkeit. Die Raten liegen bei etwa 200\,kHz.
