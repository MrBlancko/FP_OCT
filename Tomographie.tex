...
Die Glasplatte stellt eine nahezu scharfe Linie da. Durch die Auflösung der FD OCT wird diese Linie allerdings unscharf. Über diese Unschärfe lässt sich also die Auflösung des Gerätes ablesen. Eine Illustration dazu kann in Bild \ref{fig:glasplatte} gesehen werden.
\begin{align*}
l_{c, FD OCT; exp.} = 
\end{align*}

Die theoretische Auflösung der FD OCT lässt sich mithilfe der Formel 3 bestimmen:
\begin{align*}
l_{c, FD OCT; th.} = 
\end{align*}
